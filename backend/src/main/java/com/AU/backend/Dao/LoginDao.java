...
public class LoginDao {
    ...
    public User loginByGoogle(User user) throws  Exception
    {
        try
        {
            ...
            if(alreadyExist)
            {
                return jdbcTemplate.queryForObject("select firstName,lastName,emailId,userId from users where emailId='"+user.getEmailId()+"'",this::mapRowToUser);
            }
            else
            {
            ...
            User newUser= jdbcTemplate.queryForObject("select firstName,lastName,emailId,userId from users where emailId='"+user.getEmailId()+"'",this::mapRowToUser);
