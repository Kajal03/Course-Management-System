...
public class SkillCourseMappingDao {
    ...
    public List<Skills> getAllSkillsAll() throws Exception {
        try{
            List<Skills> allSkills=this.jdbcTemplate.query("select * from skills",this::mapRowToSkills);
            return allSkills;
        }
        catch (Exception e){
    ...
    private Skills mapRowToSkills(ResultSet resultSet, int rowNumber) throws SQLException {
