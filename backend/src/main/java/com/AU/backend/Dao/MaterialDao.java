...
public class MaterialDao {
    ...
    public Material getMaterialById(BigInteger materialId)
    {
        try{
            Material material= this.jdbcTemplate.queryForObject("select * from materials where materialId="+materialId,this::mapRowToMaterial);
    ...
    public Material addMaterial(Material newMaterial,MultipartFile file) throws Exception{
        ...
        BigInteger materialId=(BigInteger) keyHolder.getKey();
    ...
    public Material updateMaterial(Material newMaterial, MultipartFile newFile, int previousMaterialId) throws Exception
    {
        ...
        try{
            ...
            return getMaterialById((BigInteger) materialId);
        }
        catch (Exception e)
        {
            logger.error(e.getCause()+" in this method "+Thread.currentThread().getStackTrace()[1].getMethodName());
    ...
    public List<Material> getLatestMaterialByCourseId(int courseId) throws Exception
    {
        try{
            ...
            List<Material> material=this.jdbcTemplate.query(getLatest,this::mapRowToMaterial,courseId,true);
    ...
    public List<Material> getAllMaterialsByCourseId(int courseId, int materialId) throws Exception
    {
        try{
            ...
            Material material= this.jdbcTemplate.queryForObject(getLatest,this::mapRowToMaterial,courseId,materialId);
            ...
            while(parentId!=0)
            {
                ...
                material= this.jdbcTemplate.queryForObject(getLatest,this::mapRowToMaterial,courseId,parentId);
